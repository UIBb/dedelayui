### 首先声明，这个后台不完全是我开发，我是在网上找的一个用layui老版本修改过的，但是由于当时layui还是1.几的版本，所以使用起来有好多地方都不方便，尤其是栏目管理界面，我用layui最新版本2.5.6重新进行了修改，重点修改了里面的栏目管理界面，使用的是layui的treetable组件重新设计，现在的栏目管理一眼就可以看清楚栏目的类型，目录以及模板
