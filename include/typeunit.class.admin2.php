...
class TypeUnit
{
    ...
    function ListAllType($channel = 0, $nowdir = 0)
    {
        ...
        while ($row = $this->dsql->GetObject(0)) {
            ...
            echo "<table style=\"width:100%;margin:0;border:0;\" class=\"layui-table\"  lay-size=\"sm\" lay-skin=\"line1\">\r\n<colgroup><col width=\"60\"><col width=\"70\"><col width=\"60\"><col width=\"300\"><col width=\"150\"><col width=\"150\"><col width=\"30%\"><col></colgroup>\r\n";
            //普通列表
            if ($ispart == 0) {
                echo <<<tpl
<tr>
	...
	<td align="left">
		<a href="catalog_do.php?cid={$id}&dopost=listArchives"><b>{$typeName}</b></a>&nbsp;&nbsp;&nbsp;&nbsp;{$nss}<span class="layui-btn layui-btn-xs layui-btn-normal">列</span><span class="layui-btn layui-btn-xs layui-btn-primary">{$this->GetTotalArc($id)}</span>
	</td>
	<td align="left">
	{$ctypename}
	</td>
	...
	<td align="left">
<a href="catalog_edit.php?id={$id}" class="layui-btn layui-btn-normal layui-btn-xs"><i class="layui-icon">&#xe642;</i> 编辑</a>
<a href="{$GLOBALS['cfg_phpurl']}/list.php?tid={$id}" target="_blank" class="layui-btn layui-btn-xs"><i class="layui-icon">&#xe609;</i> 预览</a>
<a href="catalog_do.php?cid={$id}&dopost=listArchives" class="layui-btn layui-btn-xs"><i class="layui-icon">&#xe61d;</i> 内容</a>
<a href="catalog_add.php?id={$id}" class="layui-btn layui-btn-xs"><i class="layui-icon">&#xe608;</i> 子栏目</a>
<a onclick="ex_show('移动','catalog_do.php?dopost=moveCatalog&typeid={$id}','600','380')" class="layui-btn layui-btn-xs layui-btn-warm"><i class="layui-icon">&#xe633;</i> 移动</a>
<a class="layui-btn layui-btn-xs layui-btn-danger catalog_del" data-id="{$id}"><i class="layui-icon">&#xe640;</i> 删除</a>
	</td>
</tr>
tpl;
            } //带封面的频道
...
<tr>
	...
	<td align="left">
		<a href="catalog_do.php?cid={$id}&dopost=listArchives"><b>{$typeName}</b></a>&nbsp;&nbsp;&nbsp;&nbsp;{$nss}<span class="layui-btn layui-btn-xs layui-btn-danger">封</span>
	</td>
	<td align="left">
	{$ctypename}
	</td>
...
<a href="catalog_do.php?cid={$id}&dopost=listArchives" class="layui-btn layui-btn-xs"><i class="layui-icon">&#xe61d;</i> 内容</a>
<a href="catalog_add.php?id={$id}" class="layui-btn layui-btn-xs"><i class="layui-icon">&#xe608;</i> 子栏目</a>
<a onclick="ex_open('移动','catalog_do.php?dopost=moveCatalog&typeid={$id}','600','380')" class="layui-btn layui-btn-xs layui-btn-warm"><i class="layui-icon">&#xe633;</i> 移动</a>
<a class="layui-btn layui-btn-xs layui-btn-danger catalog_del" data-id="{$id}"><i class="layui-icon">&#xe640;</i> 删除</a>
	</td>
</tr>
tpl;
...
<tr>
	...
	<td align="left">
		<a href="catalog_edit.php?id={$id}"><b>{$typeName}</b></a>&nbsp;&nbsp;&nbsp;&nbsp;{$nss}<span class="layui-btn layui-btn-xs layui-btn-disabled">外</span>
	</td>
	<td align="left">
	{$ctypename}
	</td>
	...
	<td align="left">
<a href="catalog_edit.php?id={$id}" class="layui-btn layui-btn-normal layui-btn-xs"><i class="layui-icon">&#xe642;</i> 编辑</a>
<a href="{$typeDir}" target="_blank" class="layui-btn layui-btn-xs"><i class="layui-icon">&#xe609;</i> 预览</a>
<a onclick="ex_show('移动','catalog_do.php?dopost=moveCatalog&typeid={$id}','600','380')" class="layui-btn layui-btn-xs layui-btn-warm"><i class="layui-icon">&#xe633;</i> 移动</a>
<a class="layui-btn layui-btn-xs layui-btn-danger catalog_del" data-id="{$id}"><i class="layui-icon">&#xe640;</i> 删除</a>
	</td>
</tr>
tpl;
            ...
            echo "  <tr><td class='subnav' colspan='7' id='suns" . $id . "' style='padding:0;border:0;'>";
            $lastid = GetCookie('lastCid');
            if ($channel == $id || $lastid == $id || isset($GLOBALS['exallct']) || $cfg_admin_channel == 'array') {
                echo "    <table style=\"width:100%;margin:0;border:0;\" class=\"layui-table\" lay-size=\"sm\" lay-skin=\"line1\">\r\n<colgroup><col width=\"60\"><col width=\"70\"><col width=\"60\"><col width=\"300\"><col width=\"150\"><col width=\"150\"><col width=\"30%\"><col width=\"10%\"><col></colgroup>\r\n";
...
tpl;
                ...
                echo "  <tr><td class='subnav' colspan='7' id='suns" . $id . "' style='display:none;padding:0;border:0;'><table style=\"width:100%;margin:0;border:0;\" class=\"layui-table\" lay-size=\"sm\" lay-skin=\"line1\">\r\n<colgroup><col width=\"60\"><col width=\"70\"><col width=\"60\"><col width=\"300\"><col width=\"150\"><col width=\"150\"><col width=\"30%\"><col width=\"10%\"><col></colgroup>";
