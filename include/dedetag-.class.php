            ...
            foreach ($tokens as $token) {
                if (is_array($token)) {
                    if ($token[0] = '306' && in_array($token[1], $disabled_functions)) {
                        $errmsg = 'CMS Error:function disabled "' . $token[1] . '" <a href="http://help.jianzhinet.cn/install-use/apply/2013/0711/2324.html" target="_blank">more...</a>';
                        return FALSE;
                    }
                }
            }
