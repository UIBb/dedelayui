...
function lib_flink(&$ctag,&$refObj)
{
    ...
    else if($typeid == 999)
	{
		...
		if(!is_array($row))
		{
			...
			else $linkHost = 'http://flink.jianzhinet.cn/server_url.php';
			...
			if(!empty($linkInfo)){
				...
				$revalue=<<<EOT
<li><a href='http://ad.jianzhinet.cn' target='_blank' title='广告'>CMS广告</a></li><li><a href='http://service.jianzhinet.cn' target='_blank' title='客户服务中心'>
简致客户服务中心</a></li><li><a href='http://ask.jianzhinet.cn' target='_blank' title='问答'>
简致问答</a></li><li><a href='http://tools.jianzhinet.cn' target='_blank' title='站长工具'>
站长工具</a></li><li><a href='http://site.jianzhinet.cn' target='_blank' title='建站中心'>
建站中心</a></li><li><a href='http://help.jianzhinet.cn' target='_blank' title='帮助中心'>
CMS帮助中心</a></li><li><a href='http://' target='_blank' title=''>
</a></li>
EOT;
			}
			$row['reval'] = $revalue;
